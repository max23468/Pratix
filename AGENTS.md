...
- Ogni release prodotto reale deve creare anche tag Git `vX.Y.Z` e GitHub Release derivata dalla sezione rilasciata di `CHANGELOG.md`. Non creare tag o GitHub Release per `### Non versionato`, piani, ADR, guide interne o docs-only.
