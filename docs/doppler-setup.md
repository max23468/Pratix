...
```bash
gh variable set DOPPLER_PROJECT --body "Pratix" --repo max23468/Pratix
gh variable set DOPPLER_CONFIG --body "production" --repo max23468/Pratix

gh secret set DOPPLER_TOKEN --body "<service_token_read_only>" --repo max23468/Pratix
```
