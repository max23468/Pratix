...
| [`pratix-brand-memory.md`](./pratix-brand-memory.md)     | `mem://design/brand`              | Riferimento brand completo                                              |
| [`pratix-roadmap-memory.md`](./pratix-roadmap-memory.md) | `mem://process/roadmap`           | Puntatore a `docs/ROADMAP.md` e regola di sincronizzazione              |
