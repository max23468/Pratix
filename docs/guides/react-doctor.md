...
React Doctor e il controllo di qualita React usato da Pratix prima delle release major/minor o modifiche React trasversali.
...
- il debito di refactor gia noto, che non deve bloccare una release major/minor finche non viene pianificato;
