    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-3xl px-6 py-16">
        ...
        >
          ...
          ancora la versione definitiva dell'informativa.
        </div>
        ...
        <article className="prose-pratix mt-10 space-y-8 text-[15px] leading-relaxed text-foreground">
          <section>
            ...
            <p className="mt-2 text-muted-foreground">
              Titolare del trattamento dei dati personali è il gestore del servizio Pratix. Per
              esercitare i tuoi diritti puoi contattarci all'indirizzo email indicato in fondo a
              questo documento.
            </p>
          </section>
          ...
          <section>
            <h2 className="font-display text-xl font-semibold">4. Base giuridica e ruoli</h2>
            <p className="mt-2 text-muted-foreground">
              Il trattamento dei dati dell'avvocato avviene sulla base del contratto di servizio. I
              dati dei clienti finali sono trattati da Pratix in qualità di responsabile del
              trattamento, mentre l'avvocato resta titolare autonomo del trattamento nei confronti
              dei propri clienti ai sensi del GDPR.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2 text-muted-foreground">
              I dati sono conservati per la durata del rapporto contrattuale e per il tempo
              necessario ad adempiere a obblighi legali, fiscali e difensivi. L'utente può
              richiedere in qualsiasi momento la cancellazione dell'account e dei dati associati.
            </p>
          </section>

          <section>
            <h2 className="font-display text-xl font-semibold">6. Sicurezza e localizzazione</h2>
            <p className="mt-2 text-muted-foreground">
              I dati sono ospitati su infrastruttura cloud europea con cifratura in transito e a
              riposo. L'accesso ai dati di ciascun utente è limitato tramite policy di sicurezza a
              livello di riga: ogni utente vede solo i propri dati.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2 text-muted-foreground">
              Hai il diritto di accedere ai tuoi dati, rettificarli, chiederne la cancellazione,
              opporti al trattamento, richiedere la portabilità e proporre reclamo all'autorità di
          ...
          <section>
            ...
            <p className="mt-2 text-muted-foreground">
              Per ogni richiesta scrivi all'indirizzo email del gestore del servizio, indicato negli
              estremi di contatto.
            </p>
          </section>
        </article>
