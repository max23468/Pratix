    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-3xl px-6 py-16">
        ...
        >
          ...
          Non costituisce ancora la versione definitiva dei termini di servizio.
        </div>
        ...
        <article className="prose-pratix mt-10 space-y-8 text-[15px] leading-relaxed text-foreground">
          <section>
            ...
            <p className="mt-2 text-muted-foreground">
              I presenti termini disciplinano l'uso di Pratix, applicazione web
              destinata agli avvocati che esercitano la professione in forma
              individuale (freelance) per la gestione di pratiche, clienti,
              scadenze, spese e fatturazione elettronica.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2 text-muted-foreground">
              L'utente garantisce la veridicità dei dati forniti in fase di
              registrazione e si impegna a custodire le proprie credenziali. È
              vietato condividere l'account con terzi. L'utente è responsabile
              delle attività compiute tramite il proprio account.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2 text-muted-foreground">
              I dati e i contenuti inseriti dall'utente (anagrafiche clienti,
              pratiche, fatture, allegati) restano di proprietà dell'utente.
              Pratix li tratta nei limiti necessari all'erogazione del servizio,
              come descritto nell'
          ...
          <section>
            ...
            <p className="mt-2 text-muted-foreground">
              Pratix è erogato in modalità SaaS e viene mantenuto con la massima
              diligenza. Possono verificarsi interruzioni per manutenzione,
              aggiornamenti o cause di forza maggiore. Nei limiti consentiti
              dalla legge, non è garantita la continuità ininterrotta del
              servizio.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2 text-muted-foreground">
              L'utente può recedere in qualsiasi momento richiedendo la
              cancellazione del proprio account. I dati saranno cancellati nei
          ...
          <section>
            ...
            <p className="mt-2 text-muted-foreground">
              Pratix può aggiornare i presenti termini per esigenze normative,
              tecniche o di servizio. Le modifiche significative saranno
              comunicate via email o tramite avviso in app.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2 text-muted-foreground">
              ...
              consumatore, ove applicabile, oppure il foro indicato negli
              estremi di contatto.
            </p>
          </section>
        </article>
