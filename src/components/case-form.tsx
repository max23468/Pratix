...
function CasePrincipalClientFields({ controller }: { controller: ReturnType<typeof useCaseForm> }) {
  const {
    form,
    upd,
    quickPrincipalOpen,
...
function CaseCounterpartyField({ controller }: { controller: ReturnType<typeof useCaseForm> }) {
  const {
    form,
    upd,
    quickCreatedCounterparties,
...
export function CaseForm(props: Props) {
  const { initial, onCancel, onSaved } = props;
