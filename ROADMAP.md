...
| ✅    | **Versioning + Changelog + pagina Novità**    | `src/lib/version.ts` + parser `CHANGELOG.md` + route `/novita` autenticata + campanella in topbar. ADR-0008, guida `docs/guides/versioning-e-release.md` e gate post-fase per non lasciare lavori completati sotto `[Non rilasciato]`         |
...
| 🟡    | **Governance Supabase free**                  | Un solo progetto Supabase; migrations manuali con dry-run/advisors, auth hardening free e backup logico manuale fuori repo                                                                                                                    |
