...
| ✅    | **Inbox event-driven commenti Codex**         | `.github/workflows/codex-pr-comments.yml` parte su review/commenti PR, aggiorna la issue `Codex feedback inbox`, controlla tutte le PR e sollecita Codex solo sui thread actionable                                                           |
