...
| ✅    | **Inbox event-driven commenti Codex**         | `.github/workflows/codex-pr-comments.yml` parte su review/commenti PR, usa codice trusted da default branch e riallinea ogni 6 ore la issue `Codex feedback inbox`                                                                            |
